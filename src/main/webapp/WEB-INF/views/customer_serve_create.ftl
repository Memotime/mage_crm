		...
		<form id="fm" method="post">
			<table cellspacing="15px">
				<tr>
					...
					<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td>客户：</td>
                    <td><input class="easyui-combobox" id="customer"
                               name="customer"
                               data-options="panelHeight:'auto',editable:false,valueField:'name',textField:'name',url:'${ctx}/customer/queryAllCustomers'" />&nbsp;<font
                            color="red">*</font></td>
				</tr>
				<tr>
					<td>概要：</td>
