...
<div region="west" style="width: 200px" title="导航菜单" split="true">
    ...
    <#if userPermission?seq_contains('30')>
        ...
        <#if userPermission?seq_contains('3010')>
        ...
        <#if userPermission?seq_contains('3020')>
        ...
        <#if userPermission?seq_contains('3030')>
        ...
        <#if userPermission?seq_contains('3040')>
        ...
        <#if userPermission?seq_contains('3050')>
    ...
    <#if userPermission?seq_contains('50')>
        ...
        <div title="系统管理"  data-options="iconCls:'icon-item'" style="padding:10px">
            ...
            <#if userPermission?seq_contains('6030')>
